...
% Accent colour used for the table of contents, chapter labels, citations,
% and clickable links. Keep `true` for PolyU red; change it to `false` for
% an all-black, print-oriented thesis.
\newif\ifthesisredaccent
\thesisredaccenttrue % Use \thesisredaccentfalse to disable red text.
